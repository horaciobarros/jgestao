...
public class EnviaEmailIntegrator {
	...
	public void enviaEmail(String assunto, String texto, String destinatario) {
		...
		props.put("mail.smtp.user", "horacio@horaciobarros.com.br");
		props.put("mail.smtp.password", "hbsuper2@");
				...
				new javax.mail.Authenticator() {
					protected PasswordAuthentication getPasswordAuthentication() {
						return new PasswordAuthentication(
								"horacio@horaciobarros.com.br", "hbsuper2@");
					}
				});
		...
		try {
			...
			message.setFrom(new InternetAddress("horacio@horaciobarros.com.br")); // Remetente
